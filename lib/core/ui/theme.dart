...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onTertiaryContainer: Color(0xff603b50),
      ...
      onTertiaryFixedVariant: Color(0xff603b50),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff514f87),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xff603b50),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffb1849b),
      ...
      onSurfaceVariant: Color(0xffdedae6),
